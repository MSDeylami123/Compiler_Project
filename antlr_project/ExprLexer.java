...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"IF", "ELSE", "WHILE", "FOR", "RETURN", "INT_TYPE", "FLOAT_TYPE", "CHAR_TYPE", 
			"VOID_TYPE", "ASSIGN", "AND", "OR", "EQ", "NEQ", "GT", "LT", "GE", "LE", 
			"PLUS", "MINUS", "STAR", "DIV", "NOT", "SEMI", "LPAREN", "RPAREN", "LBRACE", 
			"RBRACE", "COMMA", "ID", "FLOAT", "NUMBER", "CHAR_LITERAL", "COMMENT", 
			"WS"
		};
	}
